...
<form name="myform" action="3form3.jsp" method="post">
<div id="a">
...
%>
  ...
  <legend><b><font color="blue">REFERENCES</font></b></legend>
  <details>Please enter the following details.Furnishing of incorrect information would lead to rejection of application.</details>
      ...
      First reference Name and Address  : <b><font color="red">*</font></b>    
     <textarea rows="4" cols="30" name="refname" placeholder="enter  here ">
</textarea><br><br>

      Mobile no <b><font color="red">*</font></b> 
       <input type="text" name="mobilereference" required ><br><br>



     Second Reference name and address  :  <b><font color="red">*</font></b>    
      <textarea rows="4" cols="30" name="refname1" placeholder="enter here"></textarea><br><br>
     
     Mobile no <b><font color="red">*</font></b> 
       <input type="text" name="2mobilereference" ><br><br>

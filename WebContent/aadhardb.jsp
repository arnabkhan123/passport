...
String qry="select * from aadhar where cardno=?";
String email;
String passworduser;
String email1;
String password1;
...
try{
	...
	stmt.setString(1, request.getParameter("aadhar"));
	...
	if(rs.next())	
		...
		email1=request.getParameter("aadhar");
...
{
	response.sendRedirect("aadharerr.jsp");

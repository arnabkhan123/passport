...
<form name="myform" action="aadhardb.jsp" method="post">
<div id="a">
...
out.print("<a href='Logout.jsp'><font color='red'>LOGOUT</font>"+"</a>"); %>
  ...
  <legend><b><img src="image/aadhar.jpg" width="200" height="200"><font color="blue">VERIFY YOUR AADHAR CARD</font></b></legend>
  <details>Please enter the following details.Furnishing of incorrect information would lead to rejection of application.</details>
    ...
    Enter Aadhar card no  :  <b><font color="red">*</font></b>    
      <input type="number" name="aadhar" placeholder="" required><br><br>

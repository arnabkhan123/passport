...
/* $(document).ready(function () {
    ...
    if(Cookies.get('user') == undefined) {
     window.location.replace("http://localhost/login.jsp");
...
<form name="myform" action="Loginuser.jsp" method="post">
<div id="a">
...
out.println("<h align='right'>Welcome User:</h>"+"<font color='green'>"+"["+name+"]"+"</font><br>");
out.print("<a href='Logout.jsp'><font color='red'>LOGOUT</font>"+"</a>");
%>
</fieldset>

  <fieldset style="text-align: center;">
  <legend><b><font ></font></b></legend>
  <details>Please enter the following details.Furnishing of incorrect information would lead to rejection of application.</details>
   <nav>
   <ul>
      <h><li><a href="form1.jsp">Apply fresh passport</a></li></h>
     <h><li><a href='userappointment.jsp' ><font color='blue'>Appointment status</font></a></li></h>
      <h><li><a href='viewdetailapplicationno.jsp' ><font color='blue'>view details</font></a></li></h>
      </ul>
      </nav>

...
out.println("<h align='right'>Welcome Admin:</h>"+"<font color='green'>"+"["+name+"]"+"</font><br>");
...
%>
  ...
  <details>Please enter the following details.Furnishing of incorrect information would lead to rejection of application.</details>
   <nav>
   <ul>
      <h><li><a href="customerdetails.jsp"><font color='blue'>view customer application</font></a></li></h>
     <h><li><a href='appointment.jsp' ><font color='blue'>shedule appointment</font></a></li></h>
      <h><li><a href='#' ><font color='blue'>111111111</font></a></li></h>
      </ul>
      </nav>

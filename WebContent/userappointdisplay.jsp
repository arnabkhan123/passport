...
<form name="myform" action="appointmentdb.jsp" method="post">
<div id="a">
...
String b=(String)ses.getAttribute("date");
String c=(String)ses.getAttribute("status");
...
out.print("<a href='Logout.jsp'><font color='red'>LOGOUT</font>"+"</a>"); %>
  ...
  <legend><b><img src="image/adminlogo.jpg" width="100" height="100"><font color="blue">Shedule Appointment Date</font></b></legend>
...
<button   onclick="window.location='userappointment.jsp'"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
   Prev 
</button>

...
<form name="myform" action="viewpaymentdb.jsp" method="post">
<div id="a">
...
<img src='image/gov1.png'>
  ...
  <legend><b><img src="image/d.jpg" width="100" height="100"><br><br><img src="image/sbi.jpg" width="100" height="100"><font color="blue">Make payment</font></b></legend>
  <details>Please enter the following details.Furnishing of incorrect information would lead to rejection of application.</details>
     ...
     Card No  :  <b><font color="red">*</font></b>    
      <input type="number" name="cardno" placeholder="XXXXX" required><br><br>
     
     expiry card date: <b><font color="red">*</font></b>  
       <input type="date" name="expirym"  required>   
     
                                 <!--  <input type="number" name="expiryy"  required><br><br> -->
     
      Yes to payment:<input type="checkbox" name="money" value="Rs1000" required>
      
      CVV: <input type="password" name="cvv" placeholder="XXX" required><br><br>
 ...
 Make payment >>
  ...
  <!-- <button  onclick="window.location='adminlogin.jsp' "  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
  Admin Login >>
</button> -->

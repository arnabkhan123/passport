...
<form name="myform" action="viewpayment.jsp" method="post">
<div id="a">
...
String b=(String)ses.getAttribute("dob");
String c=(String)ses.getAttribute("state");
String d=(String)ses.getAttribute("sex");
...
out.print("<a href='Logout.jsp'><font color='red'>LOGOUT</font>"+"</a>"); %>
  ...
  <legend><b><img src="image/d.jpg" width="100" height="100"><font color="blue">view details</font></b></legend>
...
<button   onclick="window.location='user.jsp'"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
   Prev 
      ...
      <button   onclick="window.location='viewpayment.jsp'" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
 make payment >>
</button>
  ...
  <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-half">
      ...
      <form action="form.asp" target="_blank">
        <p1><input class="w3-input w3-border" type="text" placeholder="Name" required name="Name"></p1>
